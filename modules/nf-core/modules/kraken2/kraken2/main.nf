process KRAKEN2_KRAKEN2 {
    ...
    def classified   = single_end ? "${prefix}.classified.fastq"   : "${prefix}.classified#.fastq"
    def unclassified = single_end ? "${prefix}.unclassified.fastq" : "${prefix}.unclassified#.fastq"
